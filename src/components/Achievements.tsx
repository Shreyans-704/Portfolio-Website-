...
export default function Achievements() {
  const certifications = [
    ...
    },
    {
      ...
      issuer: "Salesforce",
      date: "Active",
      desc: "Salesforce Trailblazer profile showcasing hands-on learning in CRM, automation, and cloud-based solutions.",
      credentialId: "",
      link: "https://www.salesforce.com/trailblazer/iisrfk5b7zdlgcgeja"
    }
  ];
